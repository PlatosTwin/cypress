...
*R24 is reserved and deliberately absent. It is held for the San Jose ingest branch, still in flight on
2026-07-31, which was handed the number at spawn time and cites it in source comments. The gap is not
an error and must not be filled by anything else.*
