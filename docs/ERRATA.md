...
*E175, E176 and E177 are reserved and deliberately absent. They are held for three branches in flight
on 2026-07-31 — the map's filter interface, the San Jose ingest, and the search field's suggestions —
each of which was handed its number at spawn time and cites it in source comments. The gap is not an
error and must not be filled by anything else.*
