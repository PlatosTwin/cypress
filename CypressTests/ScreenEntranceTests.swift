...
struct ScreenEntranceTests {
    ...
    private static func entrance(for route: Route) -> String {
        ...
        case .cityDownloads:
            ...
            // (RULINGS R43 §2) places the door on the You tab.
            return "the You tab · the Cities row (ruled, RULINGS R43 §2)"
        case .photos:
            ...
            return "03 · the hero's '3 photos · since 2024' pill (invented, E125, moved E142)"
        case .photoViewer:
            return "20 · a tap on any photograph · 03 · a tap on the hero photograph (invented, E142)"
        case .site:
