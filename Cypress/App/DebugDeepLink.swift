...
enum DebugDeepLink {
    ...
    enum Screen: String, CaseIterable {
        ...
        case journalList
        /// The Journal tab's third segment (`docs/rulings-pending/journal-city-segment.md`). Draws
        /// from the same seed the other two read, so on the shipped bundle it is never the cold-start
        /// state — both fused cities clear every card's floor.
        case journalCity
        case you                // 18
