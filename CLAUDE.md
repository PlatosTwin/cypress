...
- **There are three version spaces and this bullet will not tell you their numbers.** The
  *writable* database's migration counter is `AppSchema.currentVersion` (`PRAGMA user_version`,
  ...
  16. Both times inside the sentence written to prevent that. Say which one you mean, every time:
  four tickets sat "blocked on v14" for a week because one advanced and the other was assumed to
  have. (The third space was added by the owner's D16 ruling on the 2026-08-14 city-data
  distribution proposal, after it was found advancing unnamed.)
